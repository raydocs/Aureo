...
```bash
security export -k ~/Library/Keychains/login.keychain-db -t identities -f pkcs12 -P "YOUR_P12_PASSWORD" -o aureo-mac-signing.p12
base64 < aureo-mac-signing.p12 | pbcopy
```
