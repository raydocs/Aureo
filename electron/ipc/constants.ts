...
export const PROJECT_FILE_EXTENSION = "aureo";
...
export const ALLOW_AUREO_WINDOW_CAPTURE = Boolean(process.env["VITE_DEV_SERVER_URL"]);
export const RECORDING_SESSION_MANIFEST_SUFFIX = ".aureo-session.json";
