...
const TRUSTED_DOCUMENT_BASE_URLS = [
	...
	"file:///C:/Program%20Files/Aureo/resources/app.asar/dist/index.html",
];
...
const FILE_HUD_URL =
	"file:///C:/Program%20Files/Aureo/resources/app.asar/dist/index.html?windowType=hud-overlay";
...
describe("isTrustedCaptureDocumentUrl", () => {
	...
	])("accepts an Aureo HUD document: %s", (candidateUrl) => {
	...
	it.each([
		...
		"file:///C:/Program%20Files/Aureo/resources/app.asar/dist/other.html?windowType=hud-overlay",
		"file:///C:/Program%20Files/Aureo/resources/app.asar/dist/index.html/child?windowType=hud-overlay",
		"data:text/html,aureo?windowType=hud-overlay",
		"not a url",
	])("rejects a non-Aureo capture document: %s", (candidateUrl) => {
...
describe("shouldGrantDisplayCapture", () => {
	...
	it.each([
		["another BrowserWindow", { isTrustedCaptureWindow: false }],
		["a subframe", { isMainFrame: false }],
		["a non-Aureo document", { currentDocumentUrl: "https://example.com/" }],
