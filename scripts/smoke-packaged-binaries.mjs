...
function getExpectedNativeHelperFiles(archTag) {
	if (archTag.startsWith("win32-")) {
		...
		if (archTag === "win32-x64") {
			helpers.push({
				name: "aureo-nvidia-cuda-compositor.exe",
	...
	if (archTag.startsWith("darwin-")) {
		return [
			{
				name: "aureo-screencapturekit-helper",
				label: "ScreenCaptureKit helper",
				executable: true,
			},
			{ name: "aureo-window-list", label: "Window list helper", executable: true },
			{ name: "aureo-system-cursors", label: "System cursor helper", executable: true },
			{
				name: "aureo-native-cursor-monitor",
