 ...
 *
 * Network marketplace browse/submit actions are temporarily unavailable.
 * Local install / open-directory flows remain available.
 */
							...
							{activeTab === "browse" && (
								<div className="flex flex-col items-center justify-center gap-3 py-10">
									...
									<div className="text-center">
										...
										<p className="text-[11px] text-muted-foreground mt-1 leading-relaxed max-w-[220px]">
