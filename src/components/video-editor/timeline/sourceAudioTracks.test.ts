...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\Aureo\\recording-1.mp4", "mic")).toEqual([
			"C:/Aureo/recording-1.mic.wav",
			"C:/Aureo/recording-1.mic.m4a",
			"C:/Aureo/recording-1.mic.webm",
		]);
	});
