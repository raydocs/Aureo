...
export type ZoomMode = "auto" | "manual" | "instant";
...
export type ZoomTransitionEasing = "aureo" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "aureo";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "aureo";
