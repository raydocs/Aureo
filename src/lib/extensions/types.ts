/**
 * Aureo Extension System — Core Types
 *
...
// ---------------------------------------------------------------------------
// Extension Manifest (aureo-extension.json)
// ---------------------------------------------------------------------------
...
export interface ExtensionManifest {
	...
	license?: string;
	/** Minimum Aureo version required */
	engine?: string;
 ...
 *
 * Aureo does not auto-register these entries at runtime today.
...
export interface MarketplaceSearchResult {
	...
	page: number;
	pageSize: number;
	/** Present when the network marketplace is disabled or unavailable. */
	error?: string;
}
...
export interface AureoExtensionAPI {
...
export interface AureoExtensionModule {
	/** Called when the extension is activated */
	activate(api: AureoExtensionAPI): void | Promise<void>;
